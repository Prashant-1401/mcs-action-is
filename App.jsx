...
function AddActionPanel({ users, plants, depts, defaultPlant, defaultSrc, projects, onSave, onClose, currentUser, machines }) {
  useEscClose(onClose);
  const [f, setF] = useState({ text: "", responsible: "", due: "", section: "General", plant: defaultPlant || "", src: defaultSrc || "", priority: "NORMAL", remarks: "", project: "", reasonOfAction: "", machineName: "", actionPointType: "", actionDescription: "" });
    ...
    <>
      ...
      <div className="side-panel" style={{ width: 420, padding: 28 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div><Lbl t="Action Description" /><input value={f.actionDescription} onChange={e => up("actionDescription", e.target.value)} placeholder="Brief description of the action…" /></div>
