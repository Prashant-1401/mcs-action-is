 ...
 *
 *  All 12 tabs supported:
 *    Users, Plants, Departments, Actions, Meetings, Projects,
 *    EscalationMatrix, Permissions, MeetingPresets, Machines, Reasons, Audit
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
function setupAllTabs() {
  ...
  const TAB_HEADERS = {
    ...
    "Actions":          ["id", "sn", "text", "responsible", "due", "status", "priority", "section", "source", "plant", "dept", "machine", "reason", "remarks", "dateOfAction", "created", "closedOn", "closedBy", "revisions", "revisionHistory", "messages", "pendingConfirmation", "allocatedBy", "project"],
    "Meetings":         ["id", "type", "plant", "date", "status", "attendees", "duration", "actionCount", "notes"],
    "Projects":         ["id", "name", "plant", "dept", "status", "owner", "startDate", "endDate", "progress", "description"],
    "EscalationMatrix": ["id", "level", "label", "overdueDays", "overdueHrs", "target", "notifyMethod", "priorities", "applicableTo", "color", "active", "description"],
  ...
  Logger.log("✅ Setup complete — all 12 tabs ready.");
}
